...
Enabling SSO will not log out users who are already logged in. Users who are already logged in will be required to log in through the identity provider only after being logged out.
