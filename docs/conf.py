...
html_theme_options = {
    ...
    'announcement': '<b>Looking for an easier way?</b> Try <a href="https://getodk.org/#pricing" onclick="fathom.trackGoal("SMIXEGNN", 0);">ODK Cloud</a>, the official managed hosting service from the creators of ODK.',
