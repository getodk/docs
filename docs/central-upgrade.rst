...
This version includes a time-consuming database migration. If you have hundreds of thousands of submissions or more, consider temporarily increasing database performance before upgrading.
