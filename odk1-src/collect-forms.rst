...
.. warning::
    In Collect 1.28 filled instances of forms will still be editable after their blank form is deleted. This means that the form definition and media files will remain on the device until all the filled instances have been deleted.

    In versions prior to 1.28 deleting a blank form makes it impossible to edit filled instances of that form.
