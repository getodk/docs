...
.. _tables-sample-app-contents:

Sample Application Contents
---------------------------------

A tour of the sample application is provided in the documents linked below. It is intended to be run from top to bottom, but you can also skip to a section that interests you.
...
.. toctree::
  ...
  tables-sample-app-tea-houses
  tables-sample-app-geotagger
  tables-sample-app-plot
